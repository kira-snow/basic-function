...
class Helper( object ):
  ...
  def Info( message ):
    '''
    '''
    #print "[FusionHIFUPy " + time.strftime( "%m/%d/%Y %H:%M:%S" ) + "]: " + str( message )
    #sys.stdout.flush()
  ...
  def Warning( message ):
    '''
    '''
    #print "[FusionHIFUPy " + time.strftime( "%m/%d/%Y %H:%M:%S" ) + "]: WARNING: " + str( message )
    #sys.stdout.flush()
  ...
  def Error( message ):
    ...
    print("[FusionHIFUPy " + time.strftime( "%m/%d/%Y %H:%M:%S" ) + "]: ERROR: " + str( message )) 
    sys.stdout.flush()
  ...
  def Debug( message ):
    ...
    if showDebugOutput:
        print("[FusionHIFUPy " + time.strftime( "%m/%d/%Y %H:%M:%S" ) + "] DEBUG: " + str( message ))
        sys.stdout.flush()
  ...
  def InitVRDisplayNode(vrDisplayNode, volumeID, roiID):
    ...
    print('FusionHIFU VR: will observe ID ' + volumeID)
