...
class FusionHIFUStep( ctk.ctkWorkflowWidgetStep ) :
  ...
  def onEntry( self, comingFrom, transitionType ):
    ...
    super( FusionHIFUStep, self ).onEntry( comingFrom, transitionType )
  ...
  def onExit( self, goingTo, transitionType ):
    ...
    super( FusionHIFUStep, self ).onExit( goingTo, transitionType )
  ...
  def validationSucceeded( self, desiredBranchId ):
    '''
    '''
    super( FusionHIFUStep, self ).validate( True, desiredBranchId )
  ...
  def validationFailed( self, desiredBranchId, messageTitle='Error', messageText='There was an unknown error. See the console output for more details!' ):
    ...
    super( FusionHIFUStep, self ).validate( False, desiredBranchId )